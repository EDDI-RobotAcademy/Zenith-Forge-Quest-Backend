...
public class QUserProfile extends EntityPathBase<UserProfile> {
    ...
    private static final long serialVersionUID = -731629736L;
    ...
    public final QUserProfileImage userProfileImage;
    ...
    public QUserProfile(Class<? extends UserProfile> type, PathMetadata metadata, PathInits inits) {
        ...
        this.userProfileImage = inits.isInitialized("userProfileImage") ? new QUserProfileImage(forProperty("userProfileImage"), inits.get("userProfileImage")) : null;
    }
